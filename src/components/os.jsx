...
const Os = ({ isDarkMode }) => {
  ...
  const fullText = `Praktikum Sistem Operasi dirancang untuk memperkuat pemahaman konsep-konsep 
  dasar sistem operasi melalui pengalaman langsung di lingkungan Linux. Mahasiswa mempelajari 
  manajemen proses, memori, sistem file, dan komunikasi antarproses (IPC), serta praktik penggunaan 
  system call dan penanganan sinyal menggunakan bahasa C. Praktikum ini tidak hanya memperdalam pemahaman 
  teoritis, tetapi juga melatih keterampilan teknis seperti debugging, pengelolaan resource, dan 
  pemrograman sistem tingkat rendah yang sangat dibutuhkan dalam dunia industri teknologi dan 
            ...
            <div className="flex flex-col md:flex-row items-center gap-28">
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  alt="OS"
                  className="max-w-xs rounded-lg translate-x-11 neon-glow neon-purple pop-animation"/>
                </div>
              </div>
