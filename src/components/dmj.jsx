...
import '../styles/neonEffect.css'; // We'll create this CSS file for the animations

const Dmj = ({ isDarkMode }) => {
  const [displayedText, setDisplayedText] = useState('');
  const [currentIndex, setCurrentIndex] = useState(0);
  
  const fullText = `Praktikum Desain dan Manajemen Jaringan (DMJ) mengajarkan mahasiswa cara merancang, mengelola, dan mengamankan 
            ...
            <div className="flex flex-col md:flex-row items-center gap-28">
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  src="/DMJLogo.svg"
                  alt="DMJ"
                  className="max-w-xs rounded-lg translate-x-11 neon-glow neon-green pop-animation"/>
                </div>
              </div>
